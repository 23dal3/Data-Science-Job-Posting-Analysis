...
mod <- multinom(transformed.ownership~ Rating + Seniority + meanSalary + Revenue+ Size + Sector.new + rangeSalary+ Location.State + HQ.State + Founded+ Founded.cat, data= na.omit(glassdoor))
summary(mod)
...
optimized_mod = multinom(transformed.ownership ~ Founded.cat + Revenue + Size + Sector.new, data = glassdoor)
